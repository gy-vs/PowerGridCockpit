 ...
 * 区域负荷数据类型
 */
export type DistrictLoads = Record<string, number>
...
/**
 * 生成北京电网态势感知图配置
 * @param mode - 地图显示模式：'grid' | 'load' | 'alarm'
 * @param districtLoads - 各区负荷数据
 * @param substations500 - 500kV变电站数据
 * @param substations220 - 220kV变电站数据
 * @param substations110 - 110kV变电站数据
 * @param transmissionLines - 输电线路数据
 * @returns 完整的 ECharts option 配置对象
 */
export function getMapConfig(
  mode: MapMode,
  districtLoads: DistrictLoads,
